...
class BattleController {
    ...
    run() {
        ...
        while (this.battle.observers.length > 1) {
            console.log(`${this.battle.observers[this.battle.turnIndex].name}'s turn! HP: ${this.battle.observers[this.battle.turnIndex]
                .hitPointsCurrent}\/${this.battle.observers[this.battle.turnIndex].hitPointsBase}`);
            this.battle.attack(this.chooseRandomPlayer(this.battle.observers));
        }
